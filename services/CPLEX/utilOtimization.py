...
def solveCPLEX(subSet:list, instance: IntanceModelSolomon, time_exec: int) -> Solution:
...
def createModelMath(name: str,ins: IntanceModelSolomon):
    model = Model(name)
